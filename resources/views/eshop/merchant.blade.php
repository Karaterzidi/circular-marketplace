      ...
      <div class="col-md-4 mb-3">
        ...
        <div class="review-card card mt-3">
            <div class="review-body card-body text-center"> 
                ...
                @if(!$hasReviewed)
                <form action="/profile/{{$profile->uuid}}" method="POST">
                  @csrf
                ...
                @else
                  ...
                  <button disabled="true" class="btn btn-outline-success">
                    You have reviewed this merchant
                  </button>
                @endif
                <!-- <button disabled="true" class="btn btn-outline-success">
                  You have reviewed this Merchant
                    ...
                    <div class="card card-body mt-2">
                      <div class="media align-items-center  text-center text-lg-left flex-column flex-lg-row">
                          ...
                          <div class="media-body ml-3">
                              <h6 class="media-title font-weight-semibold"> <a href="/shop/products/{{$product->slug}}" data-abc="true">{{$product->title}}</a> </h6>
                    ...
                    <form id="profile" action="/profile" method="POST">
                      ...
                      @if($profile->user->role == 'Customer')
                        <div class="form-group">
                            ...
                            <input type="text" name="telephone" class="form-control" id="telephone" aria-describedby="titleHelp" value="{{$profile->user->telephone}}" placeholder="Enter Telephone" >
                        </div>
                        <div class="form-group">
                            <label for="address">Address</label>
                            <input type="text" name="address" class="form-control" id="address" aria-describedby="titleHelp" value="{{$profile->user->address}}" placeholder="Enter Address" >
                        </div>
                        <div class="form-group mt-3 mb-3">
                          <label style="font-size: 1rem" for="datebirth">Date of Birth</label>
                          <input name="birth_date" value="{{$profile->birth_date}}" style="font-size: 1rem" id="datebirth" class="ml-3" type="date">
                        </div>
                      @endif
                      ...
                      @if($profile->user->role == 'Company')
                        <div class="form-group">
                            ...
                            <input type="text" name="company_name" class="form-control" id="company_name" aria-describedby="titleHelp" value="{{$profile->user->company_name}}" placeholder="Enter Company name" >
                        </div>
                        <div class="form-group">
                            <label for="telephone">Telephone</label>
                            <input type="text" name="telephone" class="form-control" id="telephone" aria-describedby="titleHelp" value="{{$profile->user->telephone}}" placeholder="Enter Telephone" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vat_number" class="form-control" id="vat_number" aria-describedby="titleHelp" value="{{$profile->vat_number}}" placeholder="Enter Company name" >
                        </div>
                        <div class="form-group mt-3 mb-3">
                          <label style="font-size: 1rem" for="foundation_date">Foundation date</label>
                          <input name="foundation_date" value="{{$profile->foundation_date}}" style="font-size: 1rem" id="foundation_date" class="ml-3" type="date">
                        </div>
                      @endif
                    </form>
                </div>
