        ...
        <header class="header bg-white">
            ...
            <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="/"><span class="font-weight-bold text-uppercase text-dark">Circular Marketplace</span></a>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                    <!-- Link--><a class="nav-link" href="/admin/home">Admin Dashboard</a>
                    </li>
                    <li class="nav-item">
                    <!-- Link--><a class="nav-link" href="/admin/merchants">Users</a>
                    </li>
                    <li class="nav-item">
                    <!-- Link--><a class="nav-link" href="/admin/products">Products</a>
                    </li>
                    @if(auth()->user())
                    <li class="nav-item">
                    </li>
